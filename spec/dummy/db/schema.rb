...
ActiveRecord::Schema.define(version: 2018_06_05_144511) do
  ...
  create_table "library_categories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "object_key", limit: 12, null: false
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["object_key"], name: "library_categories_idx1"
    t.index ["organization_id", "name"], name: "library_categories_idx2"
  end

  create_table "library_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "object_key", limit: 12, null: false
    t.integer "organization_id"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["library_category_id"], name: "library_categories_idx2"
    t.index ["object_key"], name: "library_documents_idx1"
  end
